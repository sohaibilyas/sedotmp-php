...
final readonly class Platform
{
     ...
     * @return array<int|string, mixed>
     */
    public function getTrafficSourceTemplates(?array $filter = null, ?array $page = null): array
    {
        $url = $this->client->getBaseUrl().'/platform/'.$this->client->getApiVersion().'/tracking-data-templates/traffic-source';
        $queryParams = [];
        ...
        try {
            ...
            throw new \RuntimeException('Failed to fetch traffic source templates from SedoTMP API: '.$e->getMessage(), 0, $e);
        }
    }
     ...
     * @return array<int|string, mixed>
     */
    public function createTrafficSourceTemplate(array $data): array
    {
        $url = $this->client->getBaseUrl().'/platform/'.$this->client->getApiVersion().'/tracking-data-templates/traffic-source';
        ...
        try {
            ...
            throw new \RuntimeException('Failed to create traffic source template in SedoTMP API: '.$e->getMessage(), 0, $e);
        }
    }
     ...
     * @return array<int|string, mixed>
     */
    public function getTrafficSourceTemplate(string $id): array
    {
        $url = $this->client->getBaseUrl().'/platform/'.$this->client->getApiVersion().'/tracking-data-templates/traffic-source/'.$id;
        ...
        try {
            ...
            throw new \RuntimeException('Failed to fetch traffic source template from SedoTMP API: '.$e->getMessage(), 0, $e);
        }
    }
     ...
     * @return array<int|string, mixed>
     */
    public function updateTrafficSourceTemplate(string $id, array $data): array
    {
        $url = $this->client->getBaseUrl().'/platform/'.$this->client->getApiVersion().'/tracking-data-templates/traffic-source/'.$id;
        ...
        try {
            ...
            throw new \RuntimeException('Failed to update traffic source template in SedoTMP API: '.$e->getMessage(), 0, $e);
        }
    }

    public function deleteTrafficSourceTemplate(string $id): void
    {
        $url = $this->client->getBaseUrl().'/platform/'.$this->client->getApiVersion().'/tracking-data-templates/traffic-source/'.$id;
        ...
        try {
            ...
            throw new \RuntimeException('Failed to delete traffic source template from SedoTMP API: '.$e->getMessage(), 0, $e);
        }
    }
}
